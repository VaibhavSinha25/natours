      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          if (_context.t0.response) {
            ...
            (0, _alert.showAlert)('error', message || 'Something went wrong!');
          } else if (_context.t0.request) {
            // No response received
            (0, _alert.showAlert)('error', 'No response from server. Check your connection.');
          } else {
            // Other errors
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51QfN9sFJmXUawGKLFesMsGWOnmoWj2qAC8a5CDPk6UtuJzTcQP5v7LVmg4J1j1tMeewyMLCm4eSFBlXlnr5FpCrR00z4ZplHXI'); //1)get checkout session from api
          _context.next = 4;
